...
/**
 * 枚举 HTTP 状态码的常量。
 * 所有在RFC 7231（HTTP/1.1）、RFC 2518（WebDAV）、RFC 7540（HTTP/2）、 RFC 6585（附加 HTTP 状态码）、RFC 8297（早期提示）、
 * RFC 7538（永久重定向）、RFC 7725（用于报告法律障碍的 HTTP 状态码）以及RFC 2295（透明内容协商）中定义的所有状态码均已列出。
 * @author liyibo
 * @date 2026-04-03 10:01
 */
